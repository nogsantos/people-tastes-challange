		...
		this.state = {
			...
			punkapiList: [
				...
				},
				{
					...
					ingredients: {
						malt: [
							...
							{ name: 'Propino Pale Malt for kettle 0.03kg souring', amount: { value: 0.03, unit: 'kilograms' } },
				...
				},
				{
					...
					brewers_tips:
						'Dont worry too much about controlling the temperature with the Belgian yeast strain - just make sure it doesnt rise above 30°C!',
					contributed_by: 'Sam Mason <samjbmason>'
				},
				{
					id: 8,
					...
					brewers_tips:
						'Once the primary fermentation is complete get this beer as cold as you can and let it mature for as long as youve got.',
					contributed_by: 'Sam Mason <samjbmason>'
				},
				{
					id: 9,
					...
					ingredients: {
						malt: [
							...
							{ name: 'Oats', amount: { value: 1.88, unit: 'kilograms' } },
